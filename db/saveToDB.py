# -*- coding: utf-8 -*-
'''
@author: 陈作钧(学号：1607094136)
@contact: chenzj36@gmail.com
@file: saveToDB.py
@time: 2019/3/27 20:49
@function:
'''
...
s = serial.Serial('com6', 9600, timeout=2)  # 打开串口，配置串口
db = pymysql.connect("localhost", "root", "chen", "zigbee")  # 打开数据库，配置数据库
